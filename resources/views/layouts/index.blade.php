    ...
    <nav class="bg-white shadow dark:bg-gray-800 w-full">
        <div class="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300 w-full">
            ...
            <div class="flex items-center justify-end mt-4 md:mt-0 w-full">
                ...
                <a class="block w-1/2 px-3 py-2 mx-1 text-sm font-medium leading-5 text-center text-white transition-colors duration-200 transform bg-gray-500 rounded-md hover:bg-blue-600 md:mx-2 md:w-auto" href="/login">Login to dashboard</a>
                <!-- Authentication -->
